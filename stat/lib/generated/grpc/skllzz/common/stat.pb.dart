...
class TypedSkllzz extends $pb.GeneratedMessage {
  factory TypedSkllzz({required $core.int steps, required $core.int hr}) => create();
  TypedSkllzz._() : super();
...
class ProfileStats extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProfileStats', package: const $pb.PackageName(_omitMessageNames ? '' : 'com.skllzz.api'), createEmptyInstance: create)
    ...
    ..aOM<PeriodStat>(18, _omitFieldNames ? '' : 'thisFitnorm', subBuilder: PeriodStat.create)
    ..aOM<PeriodStat>(19, _omitFieldNames ? '' : 'pastFitnorm', subBuilder: PeriodStat.create)
    ...
    ..aOM<ProgressValues>(24, _omitFieldNames ? '' : 'fitnormProgress', subBuilder: ProgressValues.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(18)
  PeriodStat get thisFitnorm => $_getN(10);
  @$pb.TagNumber(18)
  set thisFitnorm(PeriodStat v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasThisFitnorm() => $_has(10);
  @$pb.TagNumber(18)
  void clearThisFitnorm() => clearField(18);
  @$pb.TagNumber(18)
  PeriodStat ensureThisFitnorm() => $_ensure(10);

  @$pb.TagNumber(19)
  PeriodStat get pastFitnorm => $_getN(11);
  @$pb.TagNumber(19)
  set pastFitnorm(PeriodStat v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasPastFitnorm() => $_has(11);
  @$pb.TagNumber(19)
  void clearPastFitnorm() => clearField(19);
  @$pb.TagNumber(19)
  PeriodStat ensurePastFitnorm() => $_ensure(11);

  @$pb.TagNumber(20)
  ProgressValues get dailyProgress => $_getN(12);
  @$pb.TagNumber(20)
  set dailyProgress(ProgressValues v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasDailyProgress() => $_has(12);
  @$pb.TagNumber(20)
  void clearDailyProgress() => clearField(20);
  @$pb.TagNumber(20)
  ProgressValues ensureDailyProgress() => $_ensure(12);

  @$pb.TagNumber(21)
  ProgressValues get weeklyProgress => $_getN(13);
  @$pb.TagNumber(21)
  set weeklyProgress(ProgressValues v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasWeeklyProgress() => $_has(13);
  @$pb.TagNumber(21)
  void clearWeeklyProgress() => clearField(21);
  @$pb.TagNumber(21)
  ProgressValues ensureWeeklyProgress() => $_ensure(13);

  @$pb.TagNumber(22)
  ProgressValues get monthlyProgress => $_getN(14);
  @$pb.TagNumber(22)
  set monthlyProgress(ProgressValues v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasMonthlyProgress() => $_has(14);
  @$pb.TagNumber(22)
  void clearMonthlyProgress() => clearField(22);
  @$pb.TagNumber(22)
  ProgressValues ensureMonthlyProgress() => $_ensure(14);

  @$pb.TagNumber(23)
  ProgressValues get yearlyProgress => $_getN(15);
  @$pb.TagNumber(23)
  set yearlyProgress(ProgressValues v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasYearlyProgress() => $_has(15);
  @$pb.TagNumber(23)
  void clearYearlyProgress() => clearField(23);
  @$pb.TagNumber(23)
  ProgressValues ensureYearlyProgress() => $_ensure(15);

  @$pb.TagNumber(24)
  ProgressValues get fitnormProgress => $_getN(16);
  @$pb.TagNumber(24)
  set fitnormProgress(ProgressValues v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasFitnormProgress() => $_has(16);
  @$pb.TagNumber(24)
  void clearFitnormProgress() => clearField(24);
  @$pb.TagNumber(24)
  ProgressValues ensureFitnormProgress() => $_ensure(16);
}
