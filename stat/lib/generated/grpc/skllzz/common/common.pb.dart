...
class OfflineDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OfflineDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'com.skllzz.api'), createEmptyInstance: create)
    ...
    ..aOM<$0.LatLng>(2, _omitFieldNames ? '' : 'location', subBuilder: $0.LatLng.create)
  ...
  @$pb.TagNumber(2)
  $0.LatLng get location => $_getN(1);
  @$pb.TagNumber(2)
  set location($0.LatLng v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLocation() => $_has(1);
  @$pb.TagNumber(2)
  void clearLocation() => clearField(2);
  @$pb.TagNumber(2)
  $0.LatLng ensureLocation() => $_ensure(1);
...
class HrDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HrDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'com.skllzz.api'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'minHr', $pb.PbFieldType.OS3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'avgHr', $pb.PbFieldType.OS3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'maxHr', $pb.PbFieldType.OS3)
  ...
  @$pb.TagNumber(1)
  set minHr($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set avgHr($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set maxHr($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
...
class TrainingSummary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainingSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'com.skllzz.api'), createEmptyInstance: create)
    ...
    ..aOM<$0.BBox>(6, _omitFieldNames ? '' : 'trackBoundingBox', subBuilder: $0.BBox.create)
  ...
  @$pb.TagNumber(6)
  $0.BBox get trackBoundingBox => $_getN(5);
  @$pb.TagNumber(6)
  set trackBoundingBox($0.BBox v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTrackBoundingBox() => $_has(5);
  @$pb.TagNumber(6)
  void clearTrackBoundingBox() => clearField(6);
  @$pb.TagNumber(6)
  $0.BBox ensureTrackBoundingBox() => $_ensure(5);
...
class TrainingPath extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainingPath', package: const $pb.PackageName(_omitMessageNames ? '' : 'com.skllzz.api'), createEmptyInstance: create)
    ...
    ..aOM<$0.BBox>(3, _omitFieldNames ? '' : 'boundingBox', subBuilder: $0.BBox.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $0.BBox get boundingBox => $_getN(2);
  @$pb.TagNumber(3)
  set boundingBox($0.BBox v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBoundingBox() => $_has(2);
  @$pb.TagNumber(3)
  void clearBoundingBox() => clearField(3);
  @$pb.TagNumber(3)
  $0.BBox ensureBoundingBox() => $_ensure(2);
}
...
class TrainingSession extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainingSession', package: const $pb.PackageName(_omitMessageNames ? '' : 'com.skllzz.api'), createEmptyInstance: create)
    ...
    ..pc<$1.ActiveArtifact>(20, _omitFieldNames ? '' : 'activeArtifacts', $pb.PbFieldType.PM, subBuilder: $1.ActiveArtifact.create)
    ..aOS(21, _omitFieldNames ? '' : 'description')
    ..aOS(22, _omitFieldNames ? '' : 'photoUrl')
  ...
  @$pb.TagNumber(20)
  $core.List<$1.ActiveArtifact> get activeArtifacts => $_getList(16);
...
class Profile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Profile', package: const $pb.PackageName(_omitMessageNames ? '' : 'com.skllzz.api'), createEmptyInstance: create)
    ...
    ..aOB(62, _omitFieldNames ? '' : 'elariConnected')
    ..aOB(63, _omitFieldNames ? '' : 'debugActivity')
    ..aOS(64, _omitFieldNames ? '' : 'city')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(62)
  $core.bool get elariConnected => $_getBF(30);
  @$pb.TagNumber(62)
  set elariConnected($core.bool v) { $_setBool(30, v); }
  @$pb.TagNumber(62)
  $core.bool hasElariConnected() => $_has(30);
  @$pb.TagNumber(62)
  void clearElariConnected() => clearField(62);

  @$pb.TagNumber(63)
  $core.bool get debugActivity => $_getBF(31);
  @$pb.TagNumber(63)
  set debugActivity($core.bool v) { $_setBool(31, v); }
  @$pb.TagNumber(63)
  $core.bool hasDebugActivity() => $_has(31);
  @$pb.TagNumber(63)
  void clearDebugActivity() => clearField(63);

  @$pb.TagNumber(64)
  $core.String get city => $_getSZ(32);
  @$pb.TagNumber(64)
  set city($core.String v) { $_setString(32, v); }
  @$pb.TagNumber(64)
  $core.bool hasCity() => $_has(32);
  @$pb.TagNumber(64)
  void clearCity() => clearField(64);
}
...
class Achievements extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Achievements', package: const $pb.PackageName(_omitMessageNames ? '' : 'com.skllzz.api'), createEmptyInstance: create)
    ...
    ..m<$core.String, $1.ActiveArtifact>(200, _omitFieldNames ? '' : 'artifacts', entryClassName: 'Achievements.ArtifactsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.ActiveArtifact.create, valueDefaultOrMaker: $1.ActiveArtifact.getDefault, packageName: const $pb.PackageName('com.skllzz.api'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(200)
  $core.Map<$core.String, $1.ActiveArtifact> get artifacts => $_getMap(10);
}
